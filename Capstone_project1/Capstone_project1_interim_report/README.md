...
- Elements: a list of the unique elements in the compound. This list can be used to check whether the compound is organic or not (i.e., organic compounds contain just a handful of elements in the periodic table).
