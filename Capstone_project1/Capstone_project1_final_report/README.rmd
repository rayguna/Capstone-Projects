...
<p align="justify">
Due to a rapid advancement in the fabrication of lightweight, compact, high-speed, and low-cost electronic/optoelectronic devices, the approach to using infrared spectroscopy for chemical identification is becoming widespread. For instance, using MEMS technology Si-Ware Systems can fabricate an FTIR system in a chip size module (http://www.neospectra.com/products-overview/). This is in contrast to the traditional bench-top and bulky FTIR system. While it is relatively straightforward to correlate the infrared spectra of a defined class of compounds or a pure material, the spectra obtained from an FTIR measurement are generally ambiguous. It requires trained personnel to interpret the data, the process can be tedious and prone to errors. Thus, there is a need to establish a routine algorithm that yield a reliable and consistent result. The goal of this project is to improve the accuracy of a computer based chemical characterization of materials using IR spectroscopy.  
</p>
